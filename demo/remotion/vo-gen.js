...
const SECTIONS = [
  ...
  ['01', "Onchain credit is amnesiac. A borrower with three years of flawless Aave repayments arrives on a new chain as a stranger. Their history is real and public, and no contract can verify it without trusting somebody to report it faithfully."],
  ...
  ['05', "Two hundred and eighty three proven facts, from a hundred and twenty eight real Ethereum borrowers, carrying nearly thirty five million dollars of Aave activity. A relayer holding no roles keeps adding to it every four minutes, whether anyone is watching or not."],
  ['06', "Those facts fold into a score, and the score sets the terms. A wallet with no proven history borrows at twenty four percent against thirty percent of its collateral. A wallet with seven hundred and seventy four borrows at eight point two, against sixty nine."],
  ['07', "Now the part that matters. When a position falls into distress, an autonomous agent restructures it instead of liquidating it."],
